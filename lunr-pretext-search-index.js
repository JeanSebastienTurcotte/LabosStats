...
{
  "id": "sssec-NomTableau-5-2",
  "level": "2",
  "url": "sec-Laboratoire_Introduction.html#sssec-NomTableau-5-2",
  "type": "Paragraphe (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "2.1",
  "title": "",
  "body": "  Créer les tableaux croisés dynamiques nécessaires pour le laboratoire  Se conscientiser à l'importance de présenter des résultats de la bonne manière.   "
},
{
  ...
  "number": "2.1.1",
  "title": "",
  "body": " Dans le fichier Excel du laboratoire, créer une nouvelle feuille de calcul intitulée Étude Obésité . Dans celle-ci, générer le tableau croisé dynamique de la répartition des femmes selon la variable Obésité .  "
},
{
...
},
{
  ...
  "number": "2.2",
  "title": "Laboratoire",
  "body": " Laboratoire   Dans ce laboratoire, on cherche à représenter la répartition du nombre de femmes d'origine pima vivant en Arizona qui sont atteintes du diabète, ainsi que leur répartition selon leur niveau d'obésité, tel que qualifié par Santé Canada en fonction de l'indice de masse corporelle.  Pour cela, on utilise les variables Atteint et Obésité , dont les tableaux croisés dynamiques ont été construits respectivement au Laboratoire 1 et au prélaboratoire précédent. On rappelle que, pour la variable Atteint , le code signifie l'absence de diabète et le code signifie que la femme est atteinte du diabète. Pour la variable Obésité , l'échelle de à se traduit par:  Poids insuffisant;  Poids normal;  Excès de poids;  Obésité classe I;  Obésité classe II;  Obésité classe III.   Dans ce laboratoire, on introduit la notion de mise en forme d'un tableau à des fins de publication, la création d'un diagramme circulaire et d'un diagramme à bandes, ainsi que la mise en forme appropriée pour ces deux éléments graphiques.    Le tableau croisé dynamique et le tableau pour publication   Le tableau croisé dynamique construit par Excel à la fin du laboratoire 1 (répartition des femmes selon la présence de diabète) n'est pas adéquat si l'on souhaite le publier comme source d'information. Par exemple, il est nécessaire de préciser le nom des catégories, d'ajouter un titre significatif et la source des données. Voici une procédure pour construire un tableau plus propice au partage des informations.  Dans la feuille Étude Atteint , on sélectionne une cellule pour commencer le tableau, par exemple H8 dans la figure . On appuie ensuite sur = , on sélectionne la plage du tableau croisé dynamique correspondant aux données et l'on appuie sur Enter .  Il est également possible de faire la combinaison Ctrl + C sur la plage des données du tableau croisé dynamique et de faire un collage spécial à l'endroit souhaité. Pour cela, on peut faire la combinaison Ctrl + V , cliquer sur l'icône de collage dans le coin inférieur bas et sélectionner Coller le lien (N) .  Dans tous les cas, il est possible qu'il faille changer le format de la cellule pour Pourcentage (voir ). On s'assure de garder deux chiffres significatifs après la virgule. L'animation ci-dessous permet de voir en trois étapes à quoi ressemble la progression de ces étapes.   Création du tableau pour présentation - première méthode   Animation de la copie des données du tableau croisé dynamique vers un tableau pour présentation - première méthode     Création du tableau pour présentation - deuxième méthode   Animation de la copie des données du tableau croisé dynamique vers un tableau pour présentation - deuxième méthode      Mise en forme tableau   Une fois les données extraites du tableau croisé dynamique, on ajoute les étiquettes de colonnes et de lignes, le titre du tableau et la source des données. Pour le moment, on ne se soucie pas de la mise en forme de ces éléments. Dans un premier temps, pour le tableau concernant la variable Atteint du diabète, les étapes qui suivent devraient mener à un tableau de quatre lignes et trois colonnes.  Mise en forme du tableau pour publication   À gauche, on ajoute une colonne appelée «Présence du diabète» dont les lignes sont, du haut vers le bas : «Non»,«Oui»,«Total». La colonne «Présence du diabète» se trouve donc dans la colonne G de la feuille de calcul.  On ajoute le titre des autres colonnes, de gauche à droite : «Nombre de femmes» et «Pourcentage de femmes». On élargit les colonnes de manière à ce que le tout soit lisible.  Dans la dernière ligne, on a le total du nombre de femmes sous chaque colonne. Sous la colonne Pourcentage de femmes à la ligne Total , on s'assure qu'il est toujours écrit , même si l'addition des nombres dans la colonne pourrait ne pas donner en raison d'erreur d'arrondi. Dans de tels cas, on l'indiquera sous le tableau à l'aide de la note : «En raison de l'arrondissement des pourcentages, le total pourrait ne pas être exactement de .»  Sous le tableau, on inscrit la source des données. Dans le cas de cette étude, la source est donnée dans la . La mention «Source : National Institute of Diabetes and Digestive and Kidney Diseases (USA)» doit apparaitre sous chacun des tableaux et des graphiques créés pour publication.  On titre le tableau. Le titre aura généralement la forme Répartition d'un échantillon (ou d'une population) de [unités statistiques] selon [la variable], [le lieu], [période ou date] .    La figure ci-dessous illustre le tableau pour publication une fois toutes les étapes effectuées.   Le tableau pour publication - après la mise en forme    Capture d'écran du tableau une fois les étapes précédentes effectuées.    Répéter les étapes ci-dessus avec le tableau croisé dynamique généré lors du prélaboratoire pour la variable Obésité dans la feuille Étude Obésité .  Ces tableaux sont appelés tableau de fréquences de la variable étudiée. S'il n'y a que la colonne du nombre d'individus, on parle alors de tableau de fréquences absolues et, s'il n'y a que la colonne des pourcentages, on dit tableau de fréquences relatives .  Habituellement, le titre, les entêtes de colonne, ainsi que le contenu de la ligne «Total» ont une mise en forme particulière, par exemple en gras.    Graphiques   Un tableau est une excellente manière de rassembler l'information d'une variable qualitative. Cela dit, illustrer la répartition des unités de manière graphique peut être aussi, et même davantage, utile. Pour une variable qualitative, il existe deux types de graphiques principaux: le diagramme circulaire et le diagramme à bandes. Dans le second cas, les bandes peuvent être horizontales ou verticales, mais, si la variable est ordinale, on préfère le diagramme à bandes verticales.  On construit le diagramme circulaire associé à la variable Atteint . On choisit de faire la répartition en pourcentage des effectifs.  Dans le tableau de fréquences de la feuille Étude Atteint , sélectionner les modalités de la variable aux cellules G8:G9 et, en maintenant la touche Ctrl enfoncée, les effectifs relatifs aux cellules I8:I9 .  Sous l'onglet Insertion , cliquer sur le bouton correspondant au diagramme circulaire dans le ruban. Voir la figure ci-dessous.  Sous Secteur 2D , cliquer sur le premier type de graphique à gauche, appelé Secteur . Déplacer le graphique au besoin.  La figure illustre les étapes précédentes sous forme d'animation.  On peut sélectionner un style prédéfini sous l'onglet création de graphique (apparaissant lorsque le graphique est sélectionné, voir la figure ) ou encore peaufiner les éléments graphiques selon ce qui est attendu. Toutefois, en sciences, l'allure esthétique du graphique ne devrait pas prendre le dessus sur l'information transmise. On préfèrera un style relativement neutre sans trop de fioritures. Le graphique circulaire doit contenir les éléments suivants:  Un titre représentatif, typiquement de la forme Répartition d'un échantillon (ou d'une population) de [unités statistiques] selon [la variable], [le lieu], [période ou date] ;  Une légende, pour distinguer les différents secteurs;  Les étiquettes correspondant aux pourcentages ou au nombre d'effectifs sur le graphique, pour une information précise;  La source, lorsque pertinente, dans le bas du graphique.  Si l'un ou plusieurs de ces éléments est manquant, on peut, lorsque le graphique est sélectionné, cliquer sur l'onglet Création de graphique et cliquer sur le bouton Ajouter un élément graphique situé dans la partie gauche du ruban. Il est aussi possible de cliquer sur le petit symbole de croix en haut à droite du graphique. La figure illustre ces deux options.     L'insertion d'un diagramme circulaire   Animation des étapes menant à l'insertion d'un diagrame circulaire.     Les styles prédéfinis d'Excel   Capture d'écran de l'endroit où l'on retrouve les styles prédéfinis dans le ruban     Ajout d'un élément graphique: deux options    Capture d'écran de l'endroit dans le ruban où l'on peut ajouter une élément graphique.    Capture d'écran de l'endroit dans près du graphique où l'on peut ajouter une élément graphique.     On construit maintenant le diagramme à bandes pour la variable Obésité . Comme la variable est qualitative et a une échelle ordinale, on choisit les bandes verticales. On choisit d'utiliser les effectifs relatifs.  Dans le tableau de fréquences de la feuille Étude Obésité , sélectionner les modalités de la variable et, en maintenant la touche Ctrl enfoncée, les effectifs relatifs.  Sous l'onglet Insertion , cliquer sur le bouton correspondant à l'histogramme. Voir la figure ci-dessous.  Sous Histogramme 2D , cliquer sur le premier type de graphique à gauche, appelé Histogramme groupé , pour un diagramme à bandes verticales.  Sous Barres 2D , cliquer sur le premier type de graphique à gauche, appelé Barres groupées , pour un diagramme à bandes horizontales.   On peut sélectionner un style prédéfini ou encore peaufiner les éléments graphiques selon ce qui est attendu. Toutefois, en sciences, l'allure esthétique du graphique ne devrait pas prendre le dessus sur l'information transmise. On préfèrera un style relativement neutre sans trop de fioritures. Le diagramme à bandes doit contenir les éléments suivants:  Un titre représentatif, typiquement de la forme Répartition d'un échantillon (ou d'une population) de [unités statistiques] selon [la variable], [le lieu], [période ou date] ;  Des titres significatifs pour les axes;  Le nom des modalités identifié clairement, sous l'axe (pour un graphique à bandes verticales), à la gauche (pour un graphique à bandes horizontales) ou encore dans une légende (pour les deux types de graphiques).  L'axe des effectifs comprend une graduation bien faite. Une note est ajoutée s'il y a eu coupure de l'axe pour sauter certaines valeurs.  Les étiquettes correspondant aux pourcentages ou au nombre d'effectifs sur le graphique, pour une information précise.  La source, lorsque pertinente, dans le bas du graphique.  Si l'un ou plusieurs de ces éléments sont manquants, on peut, lorsque le graphique est sélectionné, cliquer sur l'onglet Création de graphique et cliquer sur le bouton Ajouter un élément graphique . Il est aussi possible de cliquer sur le petit symbole de croix en haut à droite du graphique. La figure illustre ces deux options.     Insertion d'un diagramme à bandes   Capture d'écran de l'emplacement pour ajouter un diagramme à bandes     Diagramme à bandes verticales   Le résultat attendu du diagramme à bandes vertical    "
},
{
  "id": "fig-TCDaformat_anim1",
  "level": "2",
  "url": "sec-Laboratoire_Varqual.html#fig-TCDaformat_anim1",
  "type": "Figure",
  "number": "2.2.1",
  "title": "",
...
},
{
  ...
  "body": " Mise en forme du tableau pour publication   À gauche, on ajoute une colonne appelée «Présence du diabète» dont les lignes sont, du haut vers le bas : «Non»,«Oui»,«Total». La colonne «Présence du diabète» se trouve donc dans la colonne G de la feuille de calcul.  On ajoute le titre des autres colonnes, de gauche à droite : «Nombre de femmes» et «Pourcentage de femmes». On élargit les colonnes de manière à ce que le tout soit lisible.  Dans la dernière ligne, on a le total du nombre de femmes sous chaque colonne. Sous la colonne Pourcentage de femmes à la ligne Total , on s'assure qu'il est toujours écrit , même si l'addition des nombres dans la colonne pourrait ne pas donner en raison d'erreur d'arrondi. Dans de tels cas, on l'indiquera sous le tableau à l'aide de la note : «En raison de l'arrondissement des pourcentages, le total pourrait ne pas être exactement de .»  Sous le tableau, on inscrit la source des données. Dans le cas de cette étude, la source est donnée dans la . La mention «Source : National Institute of Diabetes and Digestive and Kidney Diseases (USA)» doit apparaitre sous chacun des tableaux et des graphiques créés pour publication.  On titre le tableau. Le titre aura généralement la forme Répartition d'un échantillon (ou d'une population) de [unités statistiques] selon [la variable], [le lieu], [période ou date] .  "
},
{
  "id": "ssec-MiseEnFormeTableau-5",
  "level": "2",
  "url": "sec-Laboratoire_Varqual.html#ssec-MiseEnFormeTableau-5",
  "type": "Figure",
  "number": "2.2.4",
  "title": "",
  "body": " Le tableau pour publication - après la mise en forme    Capture d'écran du tableau une fois les étapes précédentes effectuées.   "
},
{
  "id": "ssec-MiseEnFormeTableau-7",
  "level": "2",
  "url": "sec-Laboratoire_Varqual.html#ssec-MiseEnFormeTableau-7",
  "type": "Paragraphe (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "3.3.7",
  "title": "",
  "body": " Le choix de l'amplitude et du nombre de classes d'un histogramme peut influencer l'interprétation du graphique. Dans une nouvelle feuille de calcul intitulée Étude IMC 2 , reproduire l'histogramme de la répartition de l'échantillon des femmes d'origine pima selon l'indice de masse corporelle en regroupant les données en cinq classes. Il est préférable de refaire le tableau croisé dynamique. Il se peut que ceci affecte le regroupement fait à la . Interpréter l'allure du graphique. Comparer l'histogramme reproduit à l'histogramme fait à la .   "
},
{
  ...
  "number": "3.3.8",
  "title": "",
  "body": "  Choisir une variable quantitative continue (autre que l'IMC) à étudier. Ajouter une feuille de calcul dans le fichier Excel avec un nom approprié reflétant le contenu. Construire le tableau de fréquences ainsi que l'histogramme de la répartition de l'échantillon de femmes d'origine pima selon la variable choisie. Ne pas oublier de filtrer les données aberrantes, d'indiquer le choix de l'amplitude des classes et de regrouper les données. Interpréter le résultat.   "
},
{
...
},
{
  ...
  "number": "3.3.10",
  "title": "",
  "body": "  Choisir une variable quantitative continue (autre que l'IMC) à étudier simultanément avec la variable qualitative Atteint . Ajouter une feuille de calcul dans le fichier Excel avec un nom approprié reflétant le contenu. Construire le tableau de fréquences à double entrée ainsi que le polygone de fréquences de la répartition de l'échantillon de femmes d'origine pima, par présence de diabète, selon la variable quantitative continue choisie. Ne pas oublier de filtrer les données aberrantes, d'indiquer le choix de l'amplitude des classes et de regrouper les données. Interpréter le résultat.   "
},
{
...
},
{
  ...
  "number": "6.3.4",
  "title": "",
  "body": " Parmi toutes les bases de données disponibles ( vin, armée, collisions, etc.), faire deux tests d'hypothèses paramétriques de type différent en utilisant les canevas. Les hypothèses doivent être appuyées par une source crédible et rigoureuse.  "
},
{
  ...
  "number": "6.3.5",
  "title": "",
  "body": " Pour trois des quatre tests effectués dans le laboratoire 6, les cotes ou observées sont loin des valeurs critiques et les valeurs p sont très petites. Donner une ou deux raisons qui pourraient expliquer la puissance de ces rejets de l'hypothèse nulle. Les feuilles des fichiers Excel remis doivent être bien identifiées.  "
},
{
...
{
  "id": "sec-Laboratoire_correlation-3-6",
  "level": "2",
  "url": "sec-Laboratoire_correlation.html#sec-Laboratoire_correlation-3-6",
  "type": "Table",
  "number": "8.2.2",
