...
},
{
  ...
  "number": "3.1",
  "title": "",
  "body": "  Réinitialiser les filtres effectués sur les données brutes.  Créer le tableau croisé dynamique d'une variable quantitative discrète.  Construire un diagramme à bâtons.   "
},
{
...
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": "Une donnée aberrante est une donnée située anormalement loin des autres observations. Une donnée est considérée comme aberrante si elle se situe à 1,5 fois l'écart interquartile en dessous du premier quartile ou à 1,5 fois l'écart interquartile au-dessus du troisième quartile. Dans la feuille de calcul Étude IMC , déterminer toutes les valeurs aberrantes de l'indice de masse corporelle en effectuant les calculs nécessaires dans des cellules vides. À la , quelles valeurs auraient dû être exclues en plus des valeurs nulles? Quel graphique permet de visualiser (d'identifier d'un coup d'oeil) les données aberrantes d'une variable? "
},
{
...
},
{
  ...
  "number": "8.3",
  "title": "",
  "body": "  Calculer des informations manquantes à l'aide de la régression linéaire.  Poser un regard critique sur les données.  Effectuer un test d'hypothèse paramétriques pour vérifier une hypothèse.  Interpréter adéquatement la conclusion d'un test.  Construire des intervalles de confiance pour estimer une variable à l'aide d'une régression.   "
},
{
