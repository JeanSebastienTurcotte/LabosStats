...
},
{
  ...
  "body": " Mise en forme du tableau pour publication   Dans la cellule F4 , on ajouter une colonne appelée «Présence du diabète» dont les lignes sont, du haut vers le bas : «Non»,«Oui»,«Total». La colonne «Présence du diabète» se trouve donc dans la colonne F de la feuille de calcul.  On ajoute le titre des autres colonnes, de gauche à droite : «Nombre de femmes» (cellule G4 ) et «Pourcentage de femmes» (cellule H4 ). On élargit les colonnes de manière à ce que le tout soit lisible.  Dans la dernière ligne, soit la ligne , on a le total du nombre de femmes sous chaque colonne. Sous la colonne Pourcentage de femmes à la ligne Total , on s'assure qu'il est toujours écrit , même si l'addition des nombres dans la colonne pourrait ne pas donner en raison d'erreur d'arrondi. Dans de tels cas, on l'indiquera sous le tableau à l'aide de la note : «En raison de l'arrondissement des pourcentages, le total pourrait ne pas être exactement de .»  Sous le tableau, on inscrit la source des données. Dans le cas de cette étude, la source est donnée dans la . La mention «Source : National Institute of Diabetes and Digestive and Kidney Diseases (USA)» doit apparaitre sous chacun des tableaux et des graphiques créés pour publication.  On titre le tableau. Le titre aura généralement la forme Répartition d'un échantillon (ou d'une population) de [unités statistiques] selon [la variable], [le lieu], [période ou date] . Écrire ce titre dans la cellule F1 .  Le titre étant long, on aimerait le centrer au tableau. Sélectionner les cellules F1:H2 (voir la ).  Cliquer sur l'onglet Accueil Dans le groupe Alignement , sélectionner l'option Fusionner et centrer (voir la ). Les cellules F1:H2 sont maintenant considérées comme une seule cellule.  Le titre est cependant sur une ligne. On aimerait qu'il soit sur plus d'une ligne pour qu'il soit lisible. Dans le groupe Alignement , sélectionner l'option Renvoyer à la ligne automatiquement (voir la ). On peut mettre le titre en gras et augmenter la police si l'on veut.   Le tableau pour publication - après la mise en forme   Capture d'écran du tableau une fois les étapes précédentes effectuées.      "
},
{
...
{
  "id": "sec-Laboratoire_correlation-4-6",
  "level": "2",
  "url": "sec-Laboratoire_correlation.html#sec-Laboratoire_correlation-4-6",
  "type": "Table",
  "number": "8.2.2",
...
{
  "id": "sec-Laboratoire_correlation-5-6",
  "level": "2",
  "url": "sec-Laboratoire_correlation.html#sec-Laboratoire_correlation-5-6",
  "type": "Figure",
  "number": "8.2.4",
  "title": "",
