...
},
{
  ...
  "body": " Filtrer des données  Malheureusement, ce filtrage ne s'applique que sur les données du tableau principal Échantillon et non sur les tableaux croisés dynamiques.  "
},
{
...
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": "Une donnée aberrante est une donnée située anormalement loin des autres observations. Une donnée est considérée comme aberrante si elle se situe à 1,5 fois l'écart interquartile en dessous du premier quartile ou à 1,5 fois l'écart interquartile au-dessus du troisième quartile. Dans la feuille de calcul Étude IMC , déterminer toutes les valeurs aberrantes de l'indice de masse corporelle en effectuant les calculs nécessaires. À la , quelles valeurs auraient dû être exclues en plus des valeurs nulles? Quel graphique permet de visualiser (d'identifier d'un coup d'oeil) les données aberrantes d'une variable? "
},
{
