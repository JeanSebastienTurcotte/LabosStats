...
{
  "id": "sec-Laboratoire_Varqual-5-10",
  "level": "2",
  "url": "sec-Laboratoire_Varqual.html#sec-Laboratoire_Varqual-5-10",
  "type": "Figure",
  "number": "2.2.9",
  "title": "",
...
},
{
  ...
  "number": "2.3.3",
  "title": "",
  "body": " Dans le feuille Excel Étude Obésité , construire le diagramme circulaire pour aller avec la variable Obésité . Que dire du résultat?  "
},
{
...
},
{
  ...
  "number": "3.3.7",
  "title": "",
  "body": "Le choix de l'amplitude et du nombre de classes d'un histogramme peut influencer l'interprétation du graphique. Dans une nouvelle feuille de calcul intitulée Étude IMC 2 , reproduire l'histogramme de la répartition de l'échantillon des femmes d'origine pima selon l'indice de masse corporelle en regroupant les données en cinq classes. Il es préférable de refaire le tableau croisé dynamique. Il se peut que ceci affecte le regroupement fait à la . Interpréter l'allure du graphique. Comparer l'histogramme reproduit à l'histogramme fait à la .  "
},
{
